...
<div class="container" style="margin: 0 auto;margin-top: 50px">
    ...
    <div style="text-align: center;font-size: 30px;margin-bottom: 20px;color: green">Update Room</div>
    <?php
    ...
    <table  class="container table table-hover table-bordered" style="margin-top: 20px;text-align: center;">
        ...
        while ($data = mysqli_fetch_array($users)) {
            ...
            echo '<tr>
					...
					<td style="padding: 3px 1px; width: 120px;text-align: center;"><a href=\'index.php?c=updateRoomName&id='.$data["id_room"].'\' class="btn btn-primary">Update</a></td>			
					<td style="padding: 3px 1px; width: 120px;text-align: center;"><a class=\'delete btn btn-danger\'  data-confirm=\'Are you sure want to delete?\' href="index.php?c=deleteRoome&&id='.$data["id_room"].'">Delete</a></td>			
